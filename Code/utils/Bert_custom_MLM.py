...
class DataTrainingArguments:
    ...
    first: bool = field(
        default=False,
        metadata={"help": "Whether from pretrained or not"}
    )
...
def main():
    ...
    if data_args.first:
        ...
        mdl_pth = glob.glob(model_args.model_name_or_path+'/checkpoint*')[0]
        model_path = mdl_pth
    ...
    if data_args.first:
        ...
        # model=BertForMaskedLM.from_pretrained('./dakshina_10epochs/pytorch_model.bin',config=config)
    else:
